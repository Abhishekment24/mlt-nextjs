                  ...
                  <div className="offset-md-1 col-lg-10 mb-5">
                    <div className="row text-white ">
                      <div className="col-lg-12">
                        ...
                        <div className="l-content-block">
                          <h2 className="">Interpretation and Definitions</h2>
                          <p className="font-weight-bold ">Interpretation</p>
                          <p>
                          ...
                          <li>
                              ...
                              to Ment Tech . Ltd, 101, Monkstown Rd, Monkstown,
                              Blackrock Co.Dublin Ireland.
                            </li>
                            <li>Service refers to the Website.</li>
                            <li>
                              You means the individual accessing the Service, or
                              the company, or other legal entity on behalf of
                              which such individual is accessing or using the
                              Service, as applicable.
                            </li>
                            <li>
                              Website refers to Ment Tech , accessible from
                              <span className=" text-lowercase blues ">
                                {" "}
                                https://ment.tech.
                              </span>
                            </li>
                        ...
                        <div className="l-content-block">
                          <h2 className="">External Links Disclaimer</h2>
                          <p>
                        ...
                        <div className="l-content-block">
                          <h2 className="">Errors and Omissions Disclaimer</h2>
                          <p>
                        ...
                        <div className="l-content-block">
                          <h2 className="">Views Expressed Disclaimer</h2>
                          <p>
                          ...
                          <p>
                            ...
                            published by users and reserves the right to delete
                            any comment for any reason whatsoever.
                          </p>
                        </div>
                        <div className="l-content-block">
                          <h2 className="">No Responsibility Disclaimer</h2>
                          <p>
                        ...
                        <div className="l-content-block">
                          ...
                          <ul>
                            ...
                            {/*  <li>By visiting this page on our website: https://Ment Fintech Ltd /cookie-policy</li>
                  <li>By phone number: +917479866444</li>
                  <li>By mail:  Ment Fintech Ltd ,101, Monkstown Rd, Monkstown, Blackrock Co.Dublin Ireland</li>  */}
                          </ul>
                        </div>
                      </div>
                    </div>
