          ...
          <div className="container">
            <div className="row text-capitalize">
              <div className="col-lg-7">
                <h2 className="text-capitalize">Digital Marketing Executive</h2>
                <p className="font-12">Hybrid</p>
                <div>
                  <h3 className="text-capitalize">Job Description:-</h3>

                  <p className="mt-2">
                    The Digital Marketing Executive will be responsible for
                ...
                <li className="mt-2">
                  Proven experience in digital marketing, with at least 2 years
                  of experience.
                </li>
                <li className="mt-2">
                ...
                <p>
                  The Digital Marketing Executive typically works in an office
