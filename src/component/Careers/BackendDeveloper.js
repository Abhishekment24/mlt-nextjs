          ...
          <div className="container">
            <div className="row text-capitalize">
              <div className="col-lg-7">
                <h2 className="text-capitalize">Backend Developer</h2>
                <p className="font-12">Hybrid</p>
                <div>
                  <h3 className="text-capitalize">Job Description:-</h3>

                  <p className="mt-2">
                    The Backend Developer will be responsible for developing and
                    maintaining the server-side of web applications. The role
                ...
                <li className="mt-2">
                  Proven experience in backend development, with at least 2
                  years of experience.
                </li>
                <li className="mt-2">
                ...
                <p>
                  The Backend Developer typically works in an office environment
                ...
                <p>
                  ...
                  essential to understanding the scope of the Backend
